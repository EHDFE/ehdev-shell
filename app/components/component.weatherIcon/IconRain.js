...
const IconMoon = () => (
  <svg
    version="1.1"
    id="cloudRain"
    className={classnames(styles.climacon, styles.climacon_cloudRain)}
    viewBox="15 15 70 70"
  >
    ...
    <g
      className={classnames(
        ...
        styles['climacon_iconWrap-cloudRain'],
      )}
    >
      <g
        className={classnames(
          styles.climacon_wrapperComponent,
          styles['climacon_wrapperComponent-rain'],
        )}
      >
        <path
          className={classnames(
            ...
            styles['climacon_component-stroke_rain'],
            styles['climacon_component-stroke_rain-left'],
          )}
        ...
        <path
          className={classnames(
            ...
            styles['climacon_component-stroke'],
            styles['climacon_component-stroke_rain'],
            styles['climacon_component-stroke_rain-middle'],
          )}
        ...
        <path
          className={classnames(
            ...
            styles['climacon_component-stroke'],
            styles['climacon_component-stroke_rain'],
            styles['climacon_component-stroke_rain-right'],
          )}
      ...
      <g
        className={classnames(
          styles.climacon_wrapperComponent,
          styles['climacon_wrapperComponent_cloud'],
        )}
