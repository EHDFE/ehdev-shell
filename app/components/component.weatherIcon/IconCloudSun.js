...
const IconCloudSun = () => (
  <svg
    version="1.1"
    id="cloudSun"
    className={classnames(styles.climacon, styles['climacon_cloudSun'])}
    viewBox="15 15 70 70"
  >
    ...
    <g
      className={classnames(
        ...
        styles['climacon_cloudSun-iconWrap'],
      )}
    >
          ...
          >
            <path
              className={classnames(
                ...
                styles['climacon_component-stroke_sunSpoke-orth'],
              )}
