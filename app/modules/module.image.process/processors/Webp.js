  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        <ProcessItem label={'alpha 品质'} tooltip={'设置透明压缩品质'}>
        ...
        <ProcessItem
          label={'压缩方式'}
          extra={
            '编码速度和压缩品质/文件体积权衡，0(速度最快) 到 6(最慢但是品质更好)'
          }
        >
        ...
        <ProcessItem label={'无损'} tooltip={'开启无损编码'}>
        ...
        <ProcessItem
          label={'近无损压缩'}
          extra={
            '使用额外的有损预处理步骤进行无损编码，质量因子在0（最大预处理）和100（与无损相同）之间。'
          }
        >
