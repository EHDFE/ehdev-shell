...
const IconSun = () => (
  <svg
    version="1.1"
    id="sun"
    className={classnames(styles.climacon, styles.climacon_sun)}
    viewBox="15 15 70 70"
  >
        ...
        >
          ...
          <path
            className={classnames(
              ...
              styles['climacon_component-stroke'],
              styles['climacon_component-stroke_sunSpoke'],
              styles['climacon_component-stroke_sunSpoke-west'],
            )}
          ...
          <path
            className={classnames(
              ...
              styles['climacon_component-stroke'],
              styles['climacon_component-stroke_sunSpoke'],
              styles['climacon_component-stroke_sunSpoke-southWest'],
            )}
          ...
          <path
            className={classnames(
              ...
              styles['climacon_component-stroke'],
              styles['climacon_component-stroke_sunSpoke'],
              styles['climacon_component-stroke_sunSpoke-south'],
            )}
          ...
          <path
            className={classnames(
              ...
              styles['climacon_component-stroke'],
              styles['climacon_component-stroke_sunSpoke'],
              styles['climacon_component-stroke_sunSpoke-southEast'],
            )}
